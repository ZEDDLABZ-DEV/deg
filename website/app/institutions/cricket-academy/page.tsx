    ...
    <div className="overflow-hidden">
      ...
      >
        ...
        <motion.div className="absolute inset-0 z-0" style={{ y: backgroundY }}>
          <Image
            src="/images/cricket/Cricket_Img_01.jpg"
            alt="Cricket Academy"
            fill
        ...
        >
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-blue-50 max-w-3xl mx-auto mt-6 leading-relaxed font-light">
              Developing cricket talent with professional coaching and
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="rounded-2xl overflow-hidden shadow-xl">
                <Image
                  src="/images/cricket/cricket_image.png"
            ...
            >
              <h4 className="text-2xl font-semibold text-gray-900 mb-4">
                Developing Cricket Champions
              </h4>
              <p className="text-gray-600 mb-6 leading-relaxed">
                The Cricket Academy under Dildhani Education Group is dedicated
                to identifying and nurturing cricket talent in the region. With
                state-of-the-art facilities and expert coaching, we aim to
                develop skilled cricketers at all levels.
              </p>
              <p className="text-gray-600 mb-6 leading-relaxed">
                Our comprehensive training programs focus on technical skills,
                tactical understanding, physical fitness, and mental strength -
                the four pillars of cricketing excellence. We welcome players of
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-blue-100 mb-8">
                Join our academy and take the first step towards cricketing
                excellence.
              </p>
...
const programs = [
  {
    ...
    description:
      "Introduction to cricket fundamentals for young beginners aged 6-12 years.",
    image:
      "/images/cricket/Top-5-Cricket-Academies-in-Bangalore-5-1024x536.png",
  ...
  },
  {
    ...
    description:
      "High-intensity training for serious players looking to compete at higher levels.",
    image: "/images/cricket/pic4.jpg",
  ...
  },
  {
    ...
    description:
      "Elite program for talented cricketers with potential for state and national level.",
    image: "/images/cricket/1732098800_Cricket Academy in Bangalore.png",
    duration: "Full-time",
...
const facilities = [
  {
    title: "Cricket Nets",
    description:
      "Multiple practice nets with various pitch types for all-round batting and bowling practice.",
    icon: Shield,
  },
  {
    title: "Fitness Center",
    description:
      "Modern gym equipped with specialized training equipment for cricket-specific fitness development.",
    icon: Dumbbell,
  },
  {
    title: "Video Analysis",
    description:
      "Advanced video analysis system to study and improve technique and performance.",
    icon: Target,
  },
  {
    title: "Sports Medicine",
    description:
      "On-site physiotherapy and injury prevention services for players' wellbeing.",
    icon: Heart,
  },
  {
    title: "Tournament Exposure",
    description:
      "Regular participation in local, regional and national level tournaments.",
    icon: Trophy,
  },
  {
    title: "Coaching Team",
    description:
      "Experienced coaches with backgrounds in first-class and international cricket.",
    icon: Users,
  },
];
