...
const features = [
  {
    ...
    hoverGradient: "hover:bg-gradient-to-br hover:from-blue-50 hover:to-indigo-50",
  ...
  },
  {
    ...
    hoverGradient: "hover:bg-gradient-to-br hover:from-purple-50 hover:to-indigo-50",
  ...
  },
  {
    ...
    hoverGradient: "hover:bg-gradient-to-br hover:from-amber-50 hover:to-orange-50",
  ...
  },
  {
    ...
    hoverGradient: "hover:bg-gradient-to-br hover:from-rose-50 hover:to-pink-50",
  ...
  },
  {
    ...
    hoverGradient: "hover:bg-gradient-to-br hover:from-emerald-50 hover:to-teal-50",
  ...
  },
  {
    ...
    hoverGradient: "hover:bg-gradient-to-br hover:from-cyan-50 hover:to-blue-50",
          ...
          <motion.div
            ...
            style={{
              ...
              boxShadow: `0 0 8px 2px ${
                i % 6 === 0 ? "rgba(59, 130, 246, 0.3)" : 
                i % 6 === 1 ? "rgba(139, 92, 246, 0.3)" : 
                i % 6 === 2 ? "rgba(251, 191, 36, 0.3)" : 
                i % 6 === 3 ? "rgba(244, 63, 94, 0.3)" :
                i % 6 === 4 ? "rgba(16, 185, 129, 0.3)" :
                "rgba(6, 182, 212, 0.3)"
              }`,
            }}
            animate={{
              y: [0, -(20 + Math.random() * 30)],
              x: [0, (Math.random() > 0.5 ? 1 : -1) * (10 + Math.random() * 15)],
              scale: [1, 1.2, 0],
              opacity: [0, 0.7, 0],
            }}
            transition={{
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            ...
            >
              ...
              <div className={`relative bg-white rounded-lg p-8 shadow-lg h-full border border-gray-100 ${feature.borderHover} transition-all duration-300 ${feature.hoverGradient}`}>
                <div className="flex items-start space-x-5">
                  <div className={`flex-shrink-0 ${feature.iconBg} rounded-lg p-3 shadow-sm group-hover:scale-110 group-hover:rotate-6 transition-all duration-300`}>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="mt-4 pt-3 border-t border-gray-100">
                      <div className="flex items-center">
                        ...
                        <span className="text-sm text-deep-gray">Expertly designed curriculum</span>
                      </div>
                    </div>
                  </div>
                </div>
